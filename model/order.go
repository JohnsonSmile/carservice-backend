...
type Order struct {
	...
	OrderTypeID     int        `gorm:"column:order_type_id;type:tinyint(1);not null;default 0 comment '订单类型:1-highway;2-charge;3-park'" json:"order_type_id"`
	...
	EndAt           *time.Time `gorm:"column:end_at;null" json:"end_at"`
	...
	UniteCount      int        `gorm:"column:unit_count;type:int(11);not null;default 0 comment '单位数量'" json:"unit_count"`
